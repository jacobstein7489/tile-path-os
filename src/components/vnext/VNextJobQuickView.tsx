...
import { useAreasWithSurfaces, useProject, useScheduleAssignments } from "@/lib/data";
...
function StageBody({ family, project, work, files, areas, surfaces, nextSchedule, report }: { family: ReturnType<typeof stageFamily>; project: NonNullable<ReturnType<typeof useProject>["data"]>; work: ReturnType<typeof useWorkFeed>["data"] extends infer T ? NonNullable<T> : never; files: number; areas: number; surfaces: number; nextSchedule?: string; report: string | null }) {
